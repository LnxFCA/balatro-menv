...
---@field center BALATRO.Center.Back
---@field text_UI string
---@field config BALATRO.Center.Back.Config
...
---@field init fun(self: BALATRO.Back, selected_back: BALATRO.Center.Back)
---@field get_name fun(self: BALATRO.Back): string?
---@field change_to fun(self: BALATRO.Back, new_back?: BALATRO.Center.Back)
...
---@param selected_back BALATRO.Center.Back
---@return BALATRO.Back
